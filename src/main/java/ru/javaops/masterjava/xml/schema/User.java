...
public class User implements Comparable<User> {
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		User user = (User) o;
		return Objects.equals(fullName, user.fullName) && id.equals(user.id) && Objects.equals(email, user.email) && Objects.equals(city, user.city);
	}

	@Override
	public int hashCode() {

		return Objects.hash(fullName, id, email, city);
	}
}
